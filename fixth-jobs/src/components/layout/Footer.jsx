  ...
  return (
    <FooterWrapper>
      <OuterPadding>
        <TopBar>
          <Logo>
            <img src={screenWidth > 1024 ? FixthLogo : FixthFLogo} alt="Fixth Logo" />
          </Logo>
          <SocialIcons>
            <SocialIcon><img src={xIcon} alt="X / Twitter" /></SocialIcon>
            <SocialIcon><img src={LinkedInIcon} alt="LinkedIn" /></SocialIcon>
            <SocialIcon><img src={InstagramIcon} alt="Instagram" /></SocialIcon>
          </SocialIcons>
        </TopBar>
...
const OuterPadding = styled.div`
  ...
  @media (max-width: 1280px) { padding: 28px 40px 0; }
...
const SocialIcon = styled.div`
  width: 64px;
  height: 64px;
  @media (max-width: 700px) { width: 40px; height: 40px; }
  img {
    width: 100%;
    height: 100%;
    transform: scale(1.2);
...
const WatermarkWrapper = styled.div`
  ...
  pointer-events: none;
  user-select: none;
  @media (max-width: 700px) { height: 211px; }
`;
...
const WatermarkText = styled.span`
  ...
  display: block;
  @media (max-width: 700px) { font-size: 140px; }
`;
...
const BottomBarInner = styled.div`
  ...
  justify-content: space-between;
  align-items: center;
  @media (max-width: 700px) { flex-direction: column; gap: 28px; }
`;
